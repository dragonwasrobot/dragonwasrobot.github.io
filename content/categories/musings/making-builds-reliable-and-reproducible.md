...
These problem are all symptoms of the _“Works on my machine”_ life style and can
...
as `asdf` supports a simple [plugin system](https://asdf-vm.com/#/plugins-all) that makes it easy to support new
