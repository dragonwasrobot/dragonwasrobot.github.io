...
> through a system. The contracts between subsystems and the conceptual model are
> what an engineer contributes to the world. Implementations are tolerated as a
...
nature is tacit knowledge. That theory is exactly what the theory builder
...
AI Agents. Similarly, different approaches to leveraging AI-Assistance in
externalizing parts of theory building are also being explored: comparing
alternative designs or probing for implicit tradeoffs during discovery, or
codifying guiding principles using custom linter rules that uphold application
boundaries and enforce consistent use of the ubiquitous language during
