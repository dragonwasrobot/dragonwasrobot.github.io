...
Here, the evaluation of the largest exponent, $$3^4 = (3 \cdot
...
where $$r$$ has a degree less than $$d$$. In this blog post, we
...
where each intermediate result is equal to the previous result
