...
excerpt from [[https://en.wikipedia.org/wiki/Gian-Carlo_Rota][Gian-Carlo Rota's]] book *Indiscrete Thoughts (1997)*:
...
Peter Naur argued in his paper [[https://pages.cs.wisc.edu/~remzi/Naur.pdf][Programming as Theory Building (1985)]] that a
...
while an agent can produce the /text/ of a program with astonishing speed, it
cannot build, hold, nor transfer the /theory/ of it, as the theory by its very
...
[[https://arxiv.org/abs/2603.22106][From Technical Debt to Cognitive and Intent Debt: Rethinking Software Health in
the Age of AI (2026)]], where she coins the terms *Cognitive Debt* and *Intent
