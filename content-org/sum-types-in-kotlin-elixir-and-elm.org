...
** 1. Introduction
This is a follow-up post to [[/posts/product-types-in-kotlin-elixir-and-elm][Product types in Kotlin, Elixir, and Elm]]. The goal
...
In our [[/posts/enum-types-in-kotlin-elixir-and-elm][post on enum types]], we defined an enum type as a /“data type consisting
...
In our [[/posts/product-types-in-kotlin-elixir-and-elm][post on product types]] we implemented three different types of shapes:
