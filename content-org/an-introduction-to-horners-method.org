...
In our [[/posts/obtaining-taylor-polynomials-with-horners-method][next post]], we show how we can obtain [[https://en.wikipedia.org/wiki/Taylor%27s_theorem][Taylor polynomials]] using Horner's
method.
