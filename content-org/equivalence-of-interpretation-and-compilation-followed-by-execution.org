...
#+hugo_tags: "Coq" "Interactive Theorem Proving" "Interpreters" "Compilers" "Virtual Machines"
...
** 1. Introduction
This post is a follow-up to [[/posts/an-interpreter-a-compiler-and-a-virtual-machine][An interpreter, a compiler, and a virtual machine]],
...
** 3. Equivalence proof
Just as in the [[/posts/a-primer-on-the-coq-proof-assistant][introductory post on the Coq Proof Assistant]], we start our proof
