...
** 1. Introduction
This is a follow-up post to [[/posts/an-introduction-to-moessners-theorem-and-moessners-sieve][An introduction to Moessner's Theorem and Moessner's
...
This post - and [[/posts/an-introduction-to-moessners-theorem-and-moessners-sieve][the previous]] - was a small excerpt from my [[https://github.com/dragonwasrobot/formal-moessner][Master's thesis]], in
